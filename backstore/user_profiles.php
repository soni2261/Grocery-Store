...
<main>
    <div class="container-md colorfill-pink">
        <div class="row transparent">
            <div class="col-md-4">
                <a href="user_profile_edit.php" class="btn btn-dark btn-lg" role="button"><h3>Add User</h3></a>
            </div>
            <div class="col-md-4">
                <h1 style="color: black;">User Profiles</h1>
            </div>
        </div>
    </div>

    <div class="container-md" id="usersContainer">
        <form action="../user_delete_handler.php" method="post" id="form">
            <input name="email" type="hidden" id="input_email"/>
        </form>
        <div class="row colorfill-grey">
            <div class="col-md-3 d-none d-sm-none d-md-block"><h5>Email</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>First Name</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Last Name</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Postal Code </h5></div>
            <div class="col-md-1 d-none d-sm-none d-md-block"><h5>Role</h5></div>
...
<script src="user_profiles.js" rel="script"></script>
