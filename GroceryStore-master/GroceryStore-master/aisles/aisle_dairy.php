...
$products = get_prod_by_aisle("../database/inventory.json", "Dairy");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Groscerise - Dairy Aisle</title>
...
<div class="spacer-wrapper-not-animated" style="background-image: url(../assets/aisles/dairy/banner.jpg)">
</div>
