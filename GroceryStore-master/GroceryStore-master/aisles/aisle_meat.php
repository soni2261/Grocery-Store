...
$products = get_prod_by_aisle("../database/inventory.json", "Meat");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Groscerise - Meat Aisle</title>
...
<div class="spacer-wrapper-not-animated" style="background-image: url(../assets/aisles/meats/banner.jpg)">
</div>
