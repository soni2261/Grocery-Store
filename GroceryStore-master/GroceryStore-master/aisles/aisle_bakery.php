...
$products = get_prod_by_aisle("../database/inventory.json", "Bakery");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Groscerise - Bakery Aisle</title>
...
<div class="spacer-wrapper-not-animated" style="background-image: url(../assets/aisles/bakery/bakerybanner2.jpg)">
</div>
