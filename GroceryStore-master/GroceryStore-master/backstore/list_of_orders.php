...
<body>
<main>
    <div class="container-md colorfill-purple">
        <div class="row transparent">
            <h1 style="color: black;">List of orders</h1>
        </div>
    </div>
        ...
        foreach ($orders as $order) {
            ...
            echo "<div class=\"row colorfill-grey align-items-center\" id=\"orderContainer\">
                    ...
                    <button type=\"button\" class=\"btn btn-outline-dark\">
                        <a href=\"edit_order.php?id=$order_id\">
                            <h4>Edit</h4>
                        </a>
                    </button>
                    <button type=\"button\" class=\"btn btn-outline-dark\" onclick='deleteOrder($order_id )' id='$order_id'>
                        <h4>Delete</h4>
                    </button>
                </div>";
        }
