...
<main>
    <div class="fa-babyblue">
        <div class="row transparent">
            <h1 style="color: black;">Inventory - Edit</h1>
        </div>
    </div>

    <div class="container-md" id="editBlock">
        <div class="row colorfill-grey">
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Image</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Name</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Description</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Quantity</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Aisle</h5></div>
            <div class="col-md-2 d-none d-sm-none d-md-block"><h5>Price ($)</h5></div>
        </div>
        <form class="row colorfill-grey align-items-center" action="../inventory_handler.php" method="post" id="form"
              onsubmit="return isValid()" enctype="multipart/form-data">
            <div class="col-md-2">
                <img src="../assets/aisles/other/default_image.png" runat="server" class="img-thumbnail img-responsive"
                     id="image">
                <div class="row transparent">
                </div>
            ...
            <div class="col-md-2">
                <input type="product" name="product_name" class="form-control" placeholder="Product Name"
                       id="productName">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <input type="number" name="product_price" class="form-control" placeholder="Unit Price" id="price">
            </div>
            <div class="fa-babyblue" id="saveBlock">
                <div class="col-md">
                    <input type="submit" class="btn btn-outline-dark btn-lg" id="save_changes" value="Save Changes"">
                </div>
            </div>
        </form>
    </div>
...
<script src="inventory_edit.js" rel="script"></script>
