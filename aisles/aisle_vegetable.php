...
$products = get_prod_by_aisle("../database/inventory.json", "Vegetables");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Groscerise - Vegetables Aisle</title>
...
<div class="navbar-wrp">
    ...
    <div class="nav-login">
        ...
        <a href="../.html" type="button" class="btn nav-button">
            <h1 class="nav-text">Register</h1>
        </a>
    </div>
</div>
<div class="spacer-wrapper-not-animated" style="background-image: url(../assets/aisles/vegetables/banner.jpeg)">
</div>
    ...
    if ($i == $rows - 1)
        ...
        for ($j = 0; $j < 4; $j++) {
            ...
            "<div class=\"cat-wrapper\">
                ...
                <a href=\"../products/product_description_banana.html\" style=\"text-decoration: none;\">
                    <h1 class=\"name\">$name</h1>
                </a>
                <h1 class=\"price\">$$product_price/unit</h1>
            </div>";
